...
namespace HttpClientServiceHelper
{
    public partial class HttpClientHelper
    {
        ...
        public static async Task<GenericModel<T>> PostAndGetResponseAsGenericModelAsync<T>(string Route, object Model)
        {
            using (HttpClient httpClient = new HttpClient())
            {
                var uri = new Uri(Route);
        ...
        /// <param name="Token"></param>
        /// <returns>an HTTP Response Message as GenericModel of type T</returns>
        public static async Task<GenericModel<T>> PostAndGetResponseAsGenericModelAsync<T>(string Route, object Model, string Token = null)
        {
            using (HttpClient httpClient = new HttpClient())
            {
                var uri = new Uri(Route);
        ...
        /// <param name="Headers"></param>
        /// <returns>an HTTP Response Message as GenericModel of type T</returns>
        public static async Task<GenericModel<T>> PostAndGetResponseAsGenericModelAsync<T>(string Route, object Model, List<Header> Headers)
        {
            using (HttpClient httpClient = new HttpClient())
            {
                var uri = new Uri(Route);
        ...
        /// <param name="Authorization"></param>
        /// <returns>an HTTP Response Message as GenericModel of type T</returns>
        public static async Task<GenericModel<T>> PostAndGetResponseAsGenericModelAsync<T>(string Route, object Model, List<Header> Headers, Authorization Authorization)
        {
            using (HttpClient httpClient = new HttpClient())
            {
                var uri = new Uri(Route);
